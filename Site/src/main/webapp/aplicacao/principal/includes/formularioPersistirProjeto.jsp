	...
	<div id="formulario">
		<form enctype="multipart/form-data" method="post" action="<%=request.getContextPath()%>/ServletProjetos" id="projeto" name="contactForm" class="contactForm">
			...
			<div style="position: relative; left: -52px;">
				<div class="form-group">
					<label style="position: relative; left: 80px;" class="label" for="email">Foto principal:</label>
				...
				<div style="position: relative; margin-bottom: 180px; margin-top: 340px; margin-bottom: 315px;" class="row">
					<div class="col">
						<div class="form-group">
							<label style="position: relative; left: 80px;" class="label" for="email">Foto secundária 1:</label>
							<div style="position: relative;">
					...
					<div class="col">
						<div class="form-group"> 
							<label style="position: relative; left: 80px;" class="label" for="email">Foto secundária 2:</label>
							<div style="position: relative;">
				...
				<div style="position: relative; margin-bottom: 180px; margin-bottom: 315px;" class="row">
					<div class="col">
						<div class="form-group">
							<label style="position: relative; left: 80px;" class="label" for="email">Foto secundária 3:</label>
							<div style="position: relative;">
					...
					<div class="col">
						<div class="form-group">
							<label style="position: relative; left: 80px;" class="label" for="email">Foto secundária 4:</label>
							<div style="position: relative;">
				...
				<div style="position: relative; margin-bottom: 180px; margin-bottom: 315px;" class="row">
					<div class="col">
						<div class="form-group">
							<label style="position: relative; left: 80px;" class="label" for="email">Foto secundária 5:</label>
							<div style="position: relative;">
					...
					<div class="col">
						<div class="form-group">
							<label style="position: relative; left: 80px;" class="label" for="email">Foto secundária 6:</label>
							<div style="position: relative;">
